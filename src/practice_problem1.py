...
class Box(object):
    ...
    def double(self):
        ...
        #    ** TWO **   LINES OF CODE.
        #######################################################################
        submit = self.append_string(self.contents)
        return submit
    ...
    def shrink(self, new_volume):
        ...
        self.contents = ''
        submit = self.append_string(contents)
        return submit
    ...
    def double_then_shrink(self, new_volume):
        ...
        #    TIME ESTIMATE:   5 minutes.
        # ---------------------------------------------------------------------
        n = len(self.append_string(self.contents))
        contents = self.contents
        self.contents = ''
        self.volume = new_volume
        n += len(self.append_string(contents))
